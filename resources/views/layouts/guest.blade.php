...
<head>
    ...
    <link rel="stylesheet" href="{{ url('assets/compiled/css/table-datatable-jquery.css') }}">

    {{-- sweetalert --}}
    <link rel="stylesheet" href="{{ url('assets/extensions/sweetalert2/sweetalert2.min.css') }}">
    <link rel="stylesheet" href="{{ url('assets/compiled/css/extra-component-sweetalert.css') }}">
...
<body>
    ...
    <script src="{{ url('assets/js/swal-helper.js') }}"></script>

    <script>
        window.APP_CONFIG = {
            // Tambahkan backslash \ di depan App untuk memastikan dia mencari dari root
            allow_negative: {{ \App\Helpers\AppSetting::get('allow_negative_stock', '0') }},
