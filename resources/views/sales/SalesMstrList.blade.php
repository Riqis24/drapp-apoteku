        ...
        <div class="page-content">
            <div class="card">
                ...
                <div class="card-body">
                    <div class="card mb-3">
                        <div class="card-body">
                            <form action="{{ route('SalesMstr.index') }}" method="GET"
                                ...
                                <div class="col-md-4">
                                    ...
                                    <a href="{{ route('SalesMstr.index') }}" class="btn btn-sm btn-secondary">
                            ...
                            <tbody>
                                @foreach ($transactions as $transaction)
                                    <tr>
                                        ...
                                        <td style="text-align: right">{{ rupiah($transaction->sales_mstr_ppnamt) }}
                                        </td>
