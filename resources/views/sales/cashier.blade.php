<x-guest-layout>
                                        ...
                                        <td class="text-center">
                                            <div class="gap-2 d-flex justify-content-center">
                                                ...
                                                <button class="btn btn-sm btn-action btn-outline-danger"
                                                    onclick="cancelHold({{ $hold->sales_mstr_id }})" title="Batalkan">
    ...
    @push('scripts')
        <script>
            ...
            //         function addBahanToRacik(item) {
            //             const tableBody = document.getElementById('racikTableBody');
            //             const rowId = `racik-item-${item.id}`;

            //             // Cek jika item sudah ada di tabel racik
            //             if (document.getElementById(rowId)) return;

            //             const row = `
    //     <tr id="${rowId}" data-price="${item.price}">
    //         <td><span class="fw-bold">${item.name}</span></td>
    //         <td>${item.measurement}</td>
    //         <td class="text-center">${item.stock}</td>
    //         <td>
    //             <input type="number" class="form-control form-control-sm racik-qty" 
    //                 value="${item.qty}" step="any" onchange="hitungTotalRacik()">
    //         </td>
    //         <td class="text-end fw-bold racik-subtotal">
