...
return new class extends Migration {
    ...
    public function up(): void
    {
        Schema::create('user_mstr', function (Blueprint $table) {
            ...
            // $table->string('user_mstr_nik')->nullable();
            // $table->integer('user_mstr_attempt')->nullable();
            $table->integer('user_mstr_active')->nullable();
            $table->string('user_mstr_cb')->nullable();
            $table->string('user_mstr_image')->nullable();
            $table->rememberToken();
